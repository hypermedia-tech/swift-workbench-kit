...
/// entries are that folder's own children. `named` false draws the glyph alone, for the tighter
/// forms of the path; the name stays as the tooltip and as what VoiceOver reads.
///
